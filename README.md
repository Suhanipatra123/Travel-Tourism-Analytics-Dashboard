# ✈️ Travel & Tourism Analytics Dashboard
...
The **Travel & Tourism Analytics Dashboard** is an interactive Power BI project developed to analyze hotel booking performance, customer behavior, revenue trends, and tourism insights.  
...
- Booking behavior across months
...
Hotel businesses generate huge amounts of booking data daily.  
Without proper analysis, it becomes difficult to identify:
- Revenue trends
- Customer booking behavior
- High-performing hotel types
- Cancellation patterns
- Most preferred meal plans
...
- Understand hotel-wise booking contribution
- Compare market segments and distribution channels
...
- City Hotels contribute the highest number of bookings.
- BB Meal Type is the most preferred among guests.
- Online TA generates the highest bookings.
- Revenue increases during peak travel months.
...
|-----------|-------------|
| Cleaned_Travel_Tourism_Analytics_Dashboard.pbix | Main Power BI dashboard file |
| Dashboard Screenshot(img).png | Dashboard preview image |
| Travel & Tourism Analytics Dashboard.pdf | Project summary PDF |
